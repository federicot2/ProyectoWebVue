  ...
  <div>
    <v-dialog v-model="showModal" max-width="500">
      <v-card>
        ...
        <v-card-title>
          <span class="headline">Información del Roble</span>
          <v-spacer></v-spacer>
        </v-card-title>
        ...
        <v-card-text>
          ...
          <p>
            ...
            hemisferio norte.<br>
            Características: Los robles pueden variar significativamente en tamaño, desde pequeños arbustos hasta
            árboles que alcanzan más de 40 metros de altura. Tienen hojas lobuladas y producen bellotas.<br>
            Usos: La madera de roble es muy valorada por su dureza y durabilidad, utilizándose en la fabricación de
            muebles, pisos, y barriles para el envejecimiento del vino y el whisky.<br>
            Ecología: Los robles son cruciales para muchos ecosistemas, proporcionando alimento y hábitat para una
            amplia variedad de vida silvestre. Son especialmente importantes en la construcción de bosques caducifolios.
          </p>
        </v-card-text>
