    ...
    <div>
        <v-dialog v-model="showModal" max-width="500">
            <v-card>
                ...
                <v-card-title>
                    <span class="headline">Información del Cabresto</span>
                    <v-spacer></v-spacer>
                </v-card-title>
                ...
                <v-card-text>
                    ...
                    <p>
                        ...
                        regiones tropicales y subtropicales de América.<br>
                        Características: Es un árbol pequeño a mediano, que puede crecer hasta 10 metros de altura.
                        Tiene hojas perennes, brillantes y coriáceas, y produce pequeñas flores blancas o rosadas.<br>
                        Usos: A menudo se utiliza en jardines y paisajismo debido a su apariencia atractiva y a su
                        tolerancia a diferentes condiciones de suelo.<br>
                        Ecología: Es una especie que proporciona alimento a diversas aves y otros animales mediante sus
                        bayas. Además, es conocida por ser una planta medicinal en algunas culturas tradicionales.
                    </p>
                </v-card-text>
