    ...
    <div>
        <v-dialog v-model="showModal" max-width="500">
            <v-card>
                ...
                <v-card-title>
                    <span class="headline">Información del Arbol Panamá</span>
                    <v-spacer></v-spacer>
                </v-card-title>
                ...
                <v-card-text>
                    ...
                    <p>
                        ...
                        frondoso originario de las regiones tropicales de América Central y del Sur.

                        Características: Puede alcanzar alturas de 30 a 40 metros. Sus hojas son grandes y lobuladas, y
                        su tronco es recto y cilíndrico.<br>
                        Usos: La madera de este árbol es ligera y se utiliza en la fabricación de muebles y en la
                        construcción. Además, sus semillas son comestibles y se pueden usar para hacer una bebida
                        similar al chocolate.<br>
                        Ecología: Es un árbol importante en su ecosistema, proporcionando hábitat y alimento a diversas
                        especies de fauna.
                    </p>
                </v-card-text>
